...
extension Date {
    ...
    func convertDateToString(strDateFormate: String) -> String {
        ...
        formatter.dateFormat = strDateFormate
        return formatter.string(from: self)
    }

    /// Creates a date from a string using a UTC format.
    static func convertStringToDate(strDate: String, dateFormate: String) -> Date? {
        let formatter = DateFormatter()
    ...
    func getDaysBetween(_ date: Date) -> Int {
    ...
    static func convertLocalToUTC(
        ...
        convertTimeZone(
            ...
            fromZone: .current,
            to: newFormate,
            toZone: TimeZone(abbreviation: "UTC") ?? .current
        )
    }

    private static func convertTimeZone(
        _ value: String,
        from old: String,
        fromZone: TimeZone,
        to new: String,
